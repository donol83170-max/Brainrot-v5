...
LootTables.Wheels = {
    ...
    -- RNG sur 1000 : COMMON 59.5% | RARE 25% | EPIC 14% | LEGENDARY 1% | ULTRA_LEGENDARY 0.5%
    [4] = {
        Name = "Roue Brainrot",
        Cost = 20,
        Currency = "Gold",
        Items = {
            ...
            { Id = "Tralalero",        Name = "Tralalero Tralala",         Rarity = "COMMON",          SegmentId = 9  },
            { Id = "TrippiTroppi",     Name = "Trippi Troppi",             Rarity = "COMMON",          SegmentId = 11 },
            ...
            -- LEGENDARY (1%) — 1 item
            { Id = "Item67",           Name = "67",                        Rarity = "LEGENDARY",       SegmentId = 13 },

            -- ULTRA_LEGENDARY (0.5%) — 2 items
            { Id = "DragonCannell",    Name = "Dragon Cannelloni",         Rarity = "ULTRA_LEGENDARY", SegmentId = 6  },
            { Id = "StrawberryEleph",  Name = "Strawberry Elephant",       Rarity = "ULTRA_LEGENDARY", SegmentId = 15 },
        }
    },
}
